...
Config.AuthorizedVehicles = {
	Shared = {
		...
		{
			model = 'police6',
			label = 'Chevrolet Suburban(K9)'
		},
		{
			model = 'police8',
			label = 'State Chevrolet Impala'
		},
		{
			model = 'pd',
			label = 'New Dodge Charger RB'
		},
		{
			model = 'pd2',
			label = 'Old Dodge Charger RB'
		},
		{
			model = 'pd4',
			label = 'Ford Taurus RB'
		},
		{
			model = 'pd5',
			label = 'Chervolet Suburban RB'
		},
		{
			model = 'pd6',
			label = 'Chervolet Silverado RB'
		},
		{
			model = 'pd8',
			label = 'Ford Crown Victoria RB'
		},
		{
			model = 'pd9',
			label = 'Chervolet Impala RB'
		},
		{
			model = 'pbus',
