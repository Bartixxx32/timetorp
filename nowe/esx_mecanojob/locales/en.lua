Locales['en'] = {
  ['mechanic']                  = 'mechamik',
  ['drive_to_indicated']        = '~y~jedz~s~ w wyznaczone miejsce',
  ['mission_canceled']          = 'misja ~r~anulowana~s~',
  ['vehicle_list']              = 'losta pojazdow',
  ['work_wear']                 = 'ubrania robocze',
  ['civ_wear']                  = 'ubrania cywilne',
  ['deposit_stock']             = 'wloz przedmioty',
  ['withdraw_stock']            = 'wyciagnij przedmioty',
  ['boss_actions']              = 'akcje szefa',
  ['service_vehicle']           = 'serwis pojazdu',
  ['flat_bed']                  = 'plaski',
  ['tow_truck']                 = 'laweta',
  ['service_full']              = 'usluga: ',
  ['open_actions']              = 'nacisnij ~INPUT_CONTEXT~ aby otworzyc menu akcji',
  ['harvest']                   = 'naprawa',
  ['harvest_menu']              = 'nacisnij ~INPUT_CONTEXT~ to access the harvest menu.',
